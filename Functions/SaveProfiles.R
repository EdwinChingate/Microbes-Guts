...
SaveProfiles <- function(eval,SpaceLocationInf,CellVolume,GridSize,MicrobeMass,CellVolumeVec){
  time0 <- Sys.time()
  ...
  Biomass_DF <- RetrieveBiomass(eval,CellVolume,GridSize,MicrobeMass,CellVolumeVec)
